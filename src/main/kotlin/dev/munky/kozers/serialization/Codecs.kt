...
import dev.munky.kozers.util.toSnakeCase
...
inline fun <T1, reified R> codec(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(R::class.simpleName!!.toSnakeCase()) {
    ...
    val serialize: SerializationStrategy<R> = UNSAFE_serialize(descriptor, { arrayOf(gt1(it)) }, st1)
...
inline fun <T1, T2, reified R> codec(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(R::class.simpleName!!.toSnakeCase()) {
        element(nt1.toSnakeCase(), st1.descriptor)
        element(nt2.toSnakeCase(), st2.descriptor)
    }
    ...
    val serialize: SerializationStrategy<R> = UNSAFE_serialize(descriptor, { arrayOf(gt1(it), gt2(it)) }, st1, st2)
...
inline fun <T1, T2, T3, reified R> codec(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(R::class.simpleName!!.toSnakeCase()) {
        element(nt1.toSnakeCase(), st1.descriptor)
        element(nt2.toSnakeCase(), st2.descriptor)
        element(nt3.toSnakeCase(), st3.descriptor)
    }
    ...
    val serialize: SerializationStrategy<R> = UNSAFE_serialize(descriptor, { arrayOf(gt1(it), gt2(it), gt3(it)) }, st1, st2, st3)
...
inline fun <T1, T2, T3, T4, reified R> codec(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(R::class.simpleName!!.toSnakeCase()) {
        ...
        element(nt2.toSnakeCase(), st2.descriptor)
        element(nt3.toSnakeCase(), st3.descriptor)
        element(nt4.toSnakeCase(), st4.descriptor)
    }
    ...
    val serialize: SerializationStrategy<R> = UNSAFE_serialize(descriptor, { arrayOf(gt1(it), gt2(it), gt3(it), gt4(it)) }, st1, st2, st3, st4)
...
inline fun <T1, T2, T3, T4, T5, reified R> codec(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(R::class.simpleName!!.toSnakeCase()) {
        ...
        element(nt3.toSnakeCase(), st3.descriptor)
        element(nt4.toSnakeCase(), st4.descriptor)
        element(nt5.toSnakeCase(), st5.descriptor)
    }
    ...
    val serialize: SerializationStrategy<R> = UNSAFE_serialize(descriptor, {
        arrayOf(gt1(it), gt2(it), gt3(it), gt4(it), gt5(it))
    }, st1, st2, st3, st4, st5)
...
inline fun <T1, T2, T3, T4, T5, T6, reified R> codec(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(R::class.simpleName!!.toSnakeCase()) {
        ...
        element(nt4.toSnakeCase(), st4.descriptor)
        element(nt5.toSnakeCase(), st5.descriptor)
        element(nt6.toSnakeCase(), st6.descriptor)
    }
    ...
    val serialize: SerializationStrategy<R> = UNSAFE_serialize(descriptor, {
        arrayOf(gt1(it), gt2(it), gt3(it), gt4(it), gt5(it), gt6(it))
    }, st1, st2, st3, st4, st5, st6)
...
inline fun <T1, T2, T3, T4, T5, T6, T7, reified R> codec(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(R::class.simpleName!!.toSnakeCase()) {
        ...
        element(nt5.toSnakeCase(), st5.descriptor)
        element(nt6.toSnakeCase(), st6.descriptor)
        element(nt7.toSnakeCase(), st7.descriptor)
    }
    ...
    val serialize: SerializationStrategy<R> = UNSAFE_serialize(descriptor, {
        arrayOf(gt1(it), gt2(it), gt3(it), gt4(it), gt5(it), gt6(it), gt7(it))
    }, st1, st2, st3, st4, st5, st6, st7)
...
inline fun <T1, T2, T3, T4, T5, T6, T7, T8, reified R> codec(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(R::class.simpleName!!.toSnakeCase()) {
        ...
        element(nt6.toSnakeCase(), st6.descriptor)
        element(nt7.toSnakeCase(), st7.descriptor)
        element(nt8.toSnakeCase(), st8.descriptor)
    }
    ...
    val serialize: SerializationStrategy<R> = UNSAFE_serialize(descriptor, {
        arrayOf(gt1(it), gt2(it), gt3(it), gt4(it), gt5(it), gt6(it), gt7(it), gt8(it))
    }, st1, st2, st3, st4, st5, st6, st7, st8)
...
inline fun <T1, T2, T3, T4, T5, T6, T7, T8, T9, reified R> codec(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(R::class.simpleName!!.toSnakeCase()) {
        ...
        element(nt7.toSnakeCase(), st7.descriptor)
        element(nt8.toSnakeCase(), st8.descriptor)
        element(nt9.toSnakeCase(), st9.descriptor)
    }
    ...
    val serialize: SerializationStrategy<R> = UNSAFE_serialize(descriptor, {
        arrayOf(gt1(it), gt2(it), gt3(it), gt4(it), gt5(it), gt6(it), gt7(it), gt8(it), gt9(it))
    }, st1, st2, st3, st4, st5, st6, st7, st8, st9)
...
inline fun <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, reified R> codec(
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(R::class.simpleName!!.toSnakeCase()) {
        ...
        element(nt8.toSnakeCase(), st8.descriptor)
        element(nt9.toSnakeCase(), st9.descriptor)
        element(nt10.toSnakeCase(), st10.descriptor)
    }
    ...
    val serialize: SerializationStrategy<R> = UNSAFE_serialize(descriptor, {
        arrayOf(gt1(it), gt2(it), gt3(it), gt4(it), gt5(it),
            gt6(it), gt7(it), gt8(it), gt9(it), gt10(it))
    }, st1, st2, st3, st4, st5, st6, st7, st8, st9, st10)
